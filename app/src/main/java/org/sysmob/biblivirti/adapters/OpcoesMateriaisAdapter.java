 ...
 */
public class OpcoesMateriaisAdapter extends RecyclerView.Adapter<OpcoesMateriaisAdapter.ViewHolder> {
    ...
    public OpcoesMateriaisAdapter(Context context, String[] textOpcoes, TypedArray imageOpcoesAtivas, TypedArray imageOpcoesInativas, Grupo grupo) {
        this.context = context;
        this.textOpcoes = textOpcoes;
        this.imageOpcoesAtivas = imageOpcoesAtivas;
        this.imageOpcoesInativas = imageOpcoesAtivas;
        this.grupo = grupo;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_list_opcoes_materiais, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if (this.grupo.getAdmin().getUsnid() != BiblivirtiApplication.getInstance().getLoggedUser().getUsnid()) {
            ...
            if (position == OpcoesMateriaisDialog.OPTION_EDITAR || position == OpcoesMateriaisDialog.OPTION_EXCLUIR) {
