 ...
 */
public class OpcoesMembrosAdapter extends RecyclerView.Adapter<OpcoesMembrosAdapter.ViewHolder> {
    ...
    public OpcoesMembrosAdapter(Context context, String[] textOpcoes, TypedArray imageOpcoesAtivas, TypedArray imageOpcoesInativas, Grupo grupo) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_list_opcoes_membros, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if (this.grupo.getAdmin().getUsnid() != BiblivirtiApplication.getInstance().getLoggedUser().getUsnid()) {
            // Desabilita a opcoes de REMOVER DO GRUPO
            if (position == OpcoesMembrosDialog.OPTION_REMOVER_DO_GRUPO) {
